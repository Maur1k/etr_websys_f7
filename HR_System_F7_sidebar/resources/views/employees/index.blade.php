        ...
        <div class="container">
                ...
                <tbody>
                    @foreach ($employees as $employee)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('employees.downloadQrCode', $employee->id) }}"
                                    class="btn btn-download">Download QR Code</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
            ...
            <div class="pagination">
                ...
                @foreach ($employees->getUrlRange(max(1, $employees->currentPage() - 2), min($employees->lastPage(), $employees->currentPage() + 2)) as $page => $url)
                    <a href="{{ $url }}"
                        class="pagination-btn {{ $employees->currentPage() == $page ? 'active' : '' }}">{{ $page }}</a>
                @endforeach
